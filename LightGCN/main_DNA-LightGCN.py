...
from model import DNA_LightGCN
...
print('##############################')
print('This model is DNA-LightGCN!')
...
path_name = 'result/'+args.dataset+'/DNA-LightGCN_'+args.dataset+args.path_name+'.pt'
...
if not early_stopping.early_stop:
    path_name = 'result/'+args.dataset+'/DNA-LightGCN_'+args.dataset+'_not_early_stop.pt'
