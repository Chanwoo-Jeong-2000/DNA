...
class LightGCN(GraphRecommender):
    ...
    def train(self):
        ...
        for epoch in range(self.maxEpoch):
            ...
            with torch.no_grad():
                ...
                self.norm_item = torch.norm(self.item_emb, dim=1) + 1e-12
    ...
    def save(self):
        with torch.no_grad():
            ...
            temp = self.config['ds']
            torch.save(self.norm_item, f'./beta_save/{temp}origin_embedding_weight.pth')
            torch.save(self.best_user_emb, f'./beta_save/{temp}_origin_user_embedding_weight.pth')
